...
namespace TAS_SIUKDWStore.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public ActionResult Register(RegisterModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                try
                {
                    ...
                    using (TAS_SIUKDWStoreContext db = new TAS_SIUKDWStoreContext())
                    {
                        var currUser = (from c in db.UserProfiles
        ...
        public ActionResult ChangeProfile()
        {
            ...
            using (TAS_SIUKDWStoreContext db = new TAS_SIUKDWStoreContext())
            {
                model = (from u in db.UserProfiles
        ...
        [HttpPost]
        public ActionResult ChangeProfile(RegisterModel model)
        {
            using (TAS_SIUKDWStoreContext db = new TAS_SIUKDWStoreContext())
            {
                var currUser = (from u in db.UserProfiles
